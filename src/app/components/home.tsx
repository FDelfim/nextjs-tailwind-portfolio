    ...
    <div className='flex flex-col lg:flex-row-reverse w-full min-h-[300px] lg:min-h-[400px] lg:pb-20 align-bottom justify-center'>
      <div className='lg:w-2/3 w-full flex items-center'>
        <div>
          ...
          <p className='mt-4 text-justify md:text-center'>Estudante de Engenharia da Computação na Universidade Federal de Ouro Preto (UFOP), sou apaixonado por tecnologia e criar novas coisas.
